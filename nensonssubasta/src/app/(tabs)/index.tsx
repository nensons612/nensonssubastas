...
import {
  ...
  ScrollView, TouchableOpacity, StyleSheet, Platform
} from 'react-native';
...
const API_URL = 'Frontend Hostinghttps://api-j2254pyida-uc.a.run.app';
...
export default function App() {
  ...
  const fileInputRef = useRef(null); // Web input ref
